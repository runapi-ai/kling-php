 ...
 */
readonly class CompletedTextToVideoResponse extends TextToVideoResponse
{
    /**
     * Hydrate a completed text-to-video response from a RunAPI response object.
     *
     ...
     */
    public static function fromResponse(TextToVideoResponse $response): self
    {
