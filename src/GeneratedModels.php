...
/** Model slugs generated from the RunAPI Input Contract. */
final class GeneratedModels
{
    ...
    public const IMAGE_TO_VIDEO_KLING_V2_5_TURBO_IMAGE_TO_VIDEO_PRO = 'kling-v2.5-turbo-image-to-video-pro';
    ...
    public const AVATAR_KLING_V1_AVATAR_STANDARD = 'kling-v1-avatar-standard';
    public const MOTION_CONTROL_KLING_3_0 = 'kling-3.0';
